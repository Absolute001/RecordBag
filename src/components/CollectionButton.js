...
const CollectionButton = (props) => {
  return (
    <button className="my-4 invert-svg border-2 border-black ml-4 lg:hover:bg-gray-600 lg:hover:text-white lg:transform transition-transform duration-500 lg:hover:-translate-y-2">
